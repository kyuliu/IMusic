...
public class Constants {
    ...
    public static final String TIME_SERVICE_NAME = "com.example.imusic.service.CountdownService";
    public static final String LOAD_SERVICE_NAME = "com.example.imusic.service.LoadMusicDataService";
